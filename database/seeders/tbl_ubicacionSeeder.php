...
class tbl_ubicacionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('tbl_ubicacion')->insert([
            ...
            'foto_ubi'=> 'uploads/hotel_w_skybar.jpg'
        ]);
        DB::table('tbl_ubicacion')->insert([
            'nombre_ubi' => 'Maná 75',
        ...
        DB::table('tbl_ubicacion')->insert([//5
            ...
            'direccion_ubi' => 'Barcelona',
            'foto_ubi'=> 'uploads/playa_san_miquel.jpg'
        ]);
        DB::table('tbl_ubicacion')->insert([
            ...
            'direccion_ubi' => 'Barcelona',
            'foto_ubi'=> 'uploads/playa_barceloneta.jpg'
        ]);
        DB::table('tbl_ubicacion')->insert([
            ...
            'foto_ubi'=> 'uploads/museo_hist_cata.jpg'
        ]);
        DB::table('tbl_ubicacion')->insert([
            ...
            'foto_ubi'=> 'uploads/mercado_barceloneta.jpg'
        ]);
        DB::table('tbl_ubicacion')->insert([
        ...
        DB::table('tbl_ubicacion')->insert([//10
            ...
            'foto_ubi'=> 'uploads/hospital_del_mar_barceloneta.jpg'
        ]);
        DB::table('tbl_ubicacion')->insert([
            ...
            'foto_ubi'=> 'uploads/parque_barceloneta.jpg'
        ]);
        DB::table('tbl_ubicacion')->insert([
            ...
            'foto_ubi'=> 'uploads/pacha_barcelona.jpg'
        ]);
        DB::table('tbl_ubicacion')->insert([
            ...
            'foto_ubi'=> 'uploads/casino_barcelona.png'
        ]);
        DB::table('tbl_ubicacion')->insert([
        ...
        DB::table('tbl_ubicacion')->insert([
            ...
            'foto_ubi'=> 'uploads/opium_barcelona.jpeg'
        ]);
    }
}
