...
class CreateTblEtiquetaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_etiqueta', function (Blueprint $table) {
            ...
            $table->enum('icono_eti', ['bien', 'mal', 'lupa', 'globo', 'sys_hotel', 'sys_museo', 'sys_supermercado', 'sys_restaurante', 'sys_playa', 'sys_bar', 'sys_ocio', 'sys_hospital', 'sys_parque', 'sys_fav', 'sys_user']);
